...
TEMPLATES = [
    {
        ...
        # CORRECCIÓN AQUÍ: Agregamos la ruta hacia tu carpeta global de plantillas
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'appsuper.context_processors.sucursal_context',
            ],
        },
    },
]
...
LOGIN_REDIRECT_URL = '/seleccionar-sucursal/'  # Asegurate de que coincida con tu nombre en urls.py
